...
import CHIP_IO.GPIO as GPIO		# import GPIO
import time
...
try:
	...
	hx.set_gain_A(gain=128)		# You can change the gain for channel A  at any time.
	...
	data = hx.get_raw_data_mean(times=10)
